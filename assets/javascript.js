...
var page9 = '<div style="background-color:beige;padding:5px;margin-top:15px;margin-bottom:15px"><h4>Advise</h4><p>Our customers tell us that they want our sales advisors, call centre agents, and retail service representatives to “be knowledgeable and provide solutions and options.” This takes creative problem solving, good communication and teamwork.</p>'
page9+= '<h4>Activity: Self-Assessment & Action Plan</h4><p>In the left hand column below are some key things we have heard from our customers that are important to them when we solve their problems and help them find solutions.</p><p>Step One – Assess yourself. How would you rate yourself on meeting these requirements for your own customers? Excellent? Good? Fair? Or is some Improvement Needed?</p></div>'

var page10 = '<table id="behaviors"><tr><th>Advise – Key Behaviours</th><th>E-Excellent, G-good, F-fair NI – Needs Improvement</th></tr>'
page10+=  '<tr><th><ul><li>Educate and offer information and options</li><li>Share knowledge</li><li>Avoid jargon; use straightforward, clear language</li><li>Partner with your customer to narrow down options based on their needs</li><li>Collaborate with your customer to develop solutions and options</li><li>Review and tailor choices based on goals and needs</li><li>Provide recommendations (connected to customer goals and needs)</li><li>Adjust solutions based on customer feedback</li></ul></th><th></th></tr></table>'

var page11 = '<div>Step Two – Where you’ve marked yourself as a Fair or Needs Improvement, what do you feel you could be doing better to help provide the best advice and service? Record below.</div>'
page11+= '<div style="background-color:beige;padding:5px;margin-top:15px;margin-bottom:15px"><h4>Commit</h4><p>Are you rushing your customers off the phone or to the door as soon as the sale is agreed to or the immediate problem is solved? How much time do you invest in activities that help to foster commitment and loyalty in your customer and build and extend the relationship?</p></div>'
page11+= '<h4>Activity: Closing Conversations</h4><p>Closing conversations are a great opportunity to develop your relationships further by ensuring that your customer is satisfied, feels appreciated and will be returning as a loyal customer. It’s also a great opportunity to find out whether there are any other opportunities to meet their needs. At the Ritz Carlton, they call this leaving your customer with “a warm and fond farewell” and it’s a hallmark of their exceptional service.</p><p>Matching Exercise: In the left hand column of the table below are some key actions you might be doing during the Commit phase. On the right, are some responses you might say during the process of performing each key action. Draw a line to match the right action to the right response.</p>'

var page12 = '<table id="behaviors"><tr><th>Key Actions When You Commit</th><th>What to SAY or DO When Performing These Actions.</th></tr>'
page12+= '<tr><th>1 Take action and follow through on agreed upon steps</th><th>ASK: “Is there anything else I can do for you today” If something specific was mentioned during the conversation, offer to be available to discuss options for that need.</th></tr>'
page12+= '<tr><th>2 Confirm whether there are any additional opportunities to meet your customer’s needs.</th><th>ASK “How did this work for you today? Was anything we missed or could have done better?”</th></tr>'
page12+= '<tr><th>3 Check for satisfaction. How did this work for your customer? Do you think they’re coming back?</th><th>Offer sincere thanks for their time. “Thank you for being a loyal First Premium Bank customer. We appreciate your business, and look forward to helping you with any other needs you might have.”</th></tr>'
page12+= '<tr><th>4 Express authentic appreciation to your customers.</th><th>Action the request or need. SAY:“Since your immediate need is to do XYZ, let’s get started on doing this by...” Communicate any action steps to the customer including next steps for following up on them.</th></tr></table>'

var page13 = '<div style="background-color:beige;padding:5px;margin-top:15px;margin-bottom:15px"><h4>Final Reflection: Taking Action</h4><p>Review the Customer Engagement model one more time, noting each phase and key behaviours actions required at each step. Reflect upon our discussion and the notes you have captured. What are 2 or 3 ‘take-aways’ (ideas, comments, or conclusions) that have resonated with you and why? What are 1 – 2 action(s) you will take immediately on the job with your customers?</p></div>'
var array = [page1, page2, page3, page4, page5, page6, page7, page8, page9, page10, page11, page12, page13];
